document.addEventListener("DOMContentLoaded", function () {
    ...
    const episodeData = {
        1: [
            ...
            },
            {
                ...
                duration: "56m",
                desc: "Lucas, Mike and Dustin try to talk to the girl they found in the woods. Hopper questions an anxious Joyce about an unsettling phone call.",
            },
            {
                num: 3,
                title: "Holly, Jolly",
                duration: "52m",
                desc: "An increasingly concerned Nancy looks for Barb and finds out what Jonathan's been up to. Joyce is convinced Will is trying to talk to her.",
            },
            {
                num: 4,
                title: "The Body",
            ...
            },
            {
                ...
                title: "The Monster",
                duration: "47m",
                desc: "A frantic Jonathan looks for Nancy in the darkness, but Steve's looking for her, too. Hopper and Joyce uncover the truth about the lab's experiments.",
            },
        ],
        2: [
            {
                ...
                title: "MADMAX",
                duration: "49m",
                desc: "As the town preps for Halloween, a high-scoring rival shakes things up at the arcade, and a skeptical Hopper inspects a field of rotting pumpkins.",
            },
            {
                num: 2,
                title: "Trick or Treat, Freak",
                duration: "56m",
                desc: "After Will sees something terrible on trick-or-treat night, Mike wonders whether Eleven is still out there. Nancy wrestles with the truth about Barb.",
            },
            {
                num: 3,
                title: "The Pollywog",
                duration: "51m",
                desc: "Dustin adopts a strange new pet, and Eleven grows increasingly impatient. A well-meaning Bob urges Will to stand up to his fears.",
            },
            {
                num: 4,
                title: "Will the Wise",
                duration: "46m",
                desc: "An ailing Will opens up to Joyce -- with disturbing results. While Hopper digs for the truth, Eleven unearths a surprising discovery.",
            },
            {
                num: 5,
                title: "Dig Dug",
                duration: "57m",
                desc: "Nancy and Jonathan swap conspiracy theories with a new ally as Eleven searches for someone from her past. 'Bob the Brain' tackles a difficult problem.",
            },
        ],
        3: [
            {
                ...
                duration: "50m",
                desc: "Summer brings new jobs and budding romance. But the mood shifts when Dustin's radio picks up a Russian broadcast, and Will senses something is wrong.",
            },
            {
                num: 2,
                title: "The Mall Rats",
                duration: "49m",
                desc: "Nancy and Jonathan follow a lead, Steve and Robin sign on to a secret mission, and Max and Eleven go shopping. A rattled Billy has troubling visions.",
            },
            {
                num: 3,
                title: "The Case of the Missing Lifeguard",
                duration: "51m",
                desc: "With El and Max looking for Billy, Will declares a day without girls. Steve and Dustin go on a stakeout, and Joyce and Hopper return to Hawkins Lab.",
            },
            {
                num: 4,
                title: "The Sauna Test",
                duration: "52m",
                desc: "A code red brings the gang back together to face a frighteningly familiar evil. Karen urges Nancy to keep digging, and Robin finds a useful map.",
            },
            {
                num: 5,
                title: "The Flayed",
                duration: "53m",
                desc: "Strange surprises lurk inside an old farmhouse and deep beneath the Starcourt Mall. Meanwhile, the Mind Flayer is gathering strength.",
            },
        ],
        4: [
            {
                ...
                duration: "77m",
                desc: "A new evil awakens in Hawkins, bringing strange and supernatural terrors to the small town. Meanwhile, a new girl arrives at school and joins the Hellfire Club.",
            },
            {
                num: 2,
                title: "Vecna's Curse",
                duration: "78m",
                desc: "Nancy and Robin investigate a disturbing lead. Meanwhile, Eddie and the boys seek out a crucial connection. Steve struggles with his future plans.",
            },
            {
                num: 3,
                title: "The Monster and the Superhero",
                duration: "63m",
                desc: "Murray and Joyce fly to Alaska, and El faces serious consequences. Robin and Nancy dig up dirt on Hawkins' history.",
            },
            {
                num: 4,
                title: "Dear Billy",
                duration: "78m",
                desc: "Max is in grave danger and running out of time. A patient at Pennhurst asylum has visitors. Elsewhere, in Russia, Hopper is hard at work.",
            },
            {
                num: 5,
                title: "The Nina Project",
                duration: "75m",
                desc: "Owens takes El to Nevada, where she's forced to confront her past, while the Hawkins kids comb a crumbling house for clues.",
            },
            {
                num: 6,
                title: "The Dive",
                duration: "85m",
                desc: "Behind the Iron Curtain, a risky rescue mission gets underway. The California crew seeks help from a hacker. Steve takes one for the team.",
            },
        ],
    };
    ...
    window.addEventListener("scroll", () => {
        ...
        if (currentScroll <= 0) {
            navbar.style.background =
                "linear-gradient(180deg, rgba(10, 10, 10, 0.95) 0%, rgba(10, 10, 10, 0.8) 100%)";
    ...
    addToListBtns.forEach((btn) => {
        if (btn.textContent.includes("My List")) {
            btn.addEventListener("click", function (e) {
                ...
                const text = Array.from(this.childNodes).find(
    ...
    filterButtons.forEach((btn) => {
        btn.addEventListener("click", function () {
            ...
            showToast(
                `Showing ${visibleCount} ${quality === "all" ? "" : quality} file${visibleCount !== 1 ? "s" : ""
                }`
            );
        });
    });
        ...
        results.slice(0, 8).forEach((result) => {
            ...
            item.innerHTML = `
                ...
                <div class="search-result-info">
                    ...
                    <div class="search-result-meta">${typeLabel} ${year ? `• ${year}` : ""
                }</div>
                </div>
            `;
    ...
    function displayMobileSearchError() {
        ...
        if (dropdown) {
            dropdown.innerHTML =
                '<div class="search-error">Search error. Please try again.</div>';
            dropdown.classList.add("visible");
        }
    }
});
